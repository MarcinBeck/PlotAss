...
// --- ZMIENNE GLOBALNE USUNIĘTO ---

// --- FUNKCJE NAWIGACYJNE MODALA USUNIĘTO ---

// --- FUNKCJA GŁÓWNA DASHBOARD FETCH ---
...
async function fetchData() {
    try {
        ...
        updateSceneSection(data.chapters); // Na razie używamy danych z rozdziałów jako placeholder
...
function updateSceneSection(chaptersData) {
    ...
    // Suma scen ze wszystkich rozdziałów (Placeholder)
    ...
    // Na razie lista scen jest statyczna/placeholderem, dopóki nie dodasz tabeli scen.
    list.innerHTML = `
...
// --- FUNKCJE MODALI DETALI POSTACI/ROZDZIAŁÓW USUNIĘTO ---
